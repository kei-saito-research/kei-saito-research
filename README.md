...
I build frameworks for ambiguity-preserving AI instead of jumping to conclusions — and test whether that improves efficiency and quality in LLM systems.
...
- Current manuscript snapshots under each repo's `manuscript/current/`
- Reproducibility guides, configs, and run scripts
- Cross-paper mapping of scope, status, and links in the series hub
